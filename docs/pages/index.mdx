...
<Callout type="info">
  The dataset used in these example code snippets was gotten from Kaggle; [Employee Salaries for different job
  roles](https://www.kaggle.com/datasets/inductiveanks/employee-salaries-for-different-job-roles)
</Callout>
