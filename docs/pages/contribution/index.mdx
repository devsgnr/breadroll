...
All development happens directly on [GitHub](https://github.com/devsgnr/breadroll). Both core team members and external contributors (via forks) send pull requests which go through the same review process.
...
**Note:** When submitting your pull request, we highly recommend that you write test case(s) that accompanies the pull request you are submitting
