---
title: .cols
description: returns specific columns of the dataframe strictly using interger based indexing similar to panda's iloc, it takes an object with either the start or the end index and return the dataframe with the specified columns
---
