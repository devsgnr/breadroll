---
title: Changelog
description: Improvements to the Breadroll and the Dataframe API, Introduction of a new remote data source, A snazzy new way to perform data transformation, Introuducing NumericConstants - a collection of mathematical and physical constants and more. breadroll hit 35 🌠 stars on GitHub - help breadroll rise higher, drop a star.
---
